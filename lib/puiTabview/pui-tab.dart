...
class PuiTabComponent extends PuiBaseComponent implements NgShadowRootAware  {
  /** The <pui-tag> field as defined in the HTML source code. */
  Element puiTabElement;

  /** The scope is needed to add watches. */
  Scope scope;

  /**
   * Initializes the component by setting the <pui-tab> field and setting the scope.
   */
  PuiTabComponent(this.scope, this.puiTabElement) {}
  ...
  void onShadowRoot(ShadowRoot shadowRoot) {
    copyAttributesToShadowDOM(puiTabElement, null, scope);
    addWatches(puiTabElement, null, scope);
  }
}
